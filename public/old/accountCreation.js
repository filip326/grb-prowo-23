...
function displayData() {
    ...
    rows.forEach((row, rowN) => {
        ...
        row.forEach((cell, cellN) => {
            ...
            td.setAttribute('sheet', activeSheet);
            td.setAttribute('row', rowN);
            td.setAttribute('col', cellN);
            td.textContent = cell ?? "";
    ...
    function selectCell(cell) {
        ...
        const sheet = cell.getAttribute('sheet');
        const row = cell.getAttribute('row');
        const col = cell.getAttribute('col');

        if (!selectedData.includes(sheet, row, col))
            selectedData.push([sheet, row, col])
